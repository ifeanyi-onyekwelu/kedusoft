...
import { getAllApplications, deleteApplication } from "@/apis/tenantApi.tsx";
...
function Applications() {
  ...
  if (loading) {
    return (
      <BrandedLoader inDashboard={true} label="Getting your applications..." />
    );
  }
        ...
        <EmptyState>
          <Stack align="center" gap="xl" className="max-w-md">
            ...
            <Stack gap="xs" align="center" className="text-center">
              ...
              >
                Your property journey starts here. Once you find a place you
                love, your application progress will appear in this dashboard.
              </Text>
            </Stack>
